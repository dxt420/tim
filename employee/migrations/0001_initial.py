# Generated by Django 2.1.7 on 2020-10-25 09:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pickup_address', models.CharField(blank=True, max_length=50)),
                ('dropoff_address', models.CharField(blank=True, max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_title', models.CharField(blank=True, max_length=50)),
                ('report_details', models.CharField(blank=True, max_length=500)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
            name='TimeSlot',
            fields=[
                ('employee_shift_time', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dropoff_address', models.CharField(blank=True, max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('time_slot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='employee.TimeSlot')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, max_length=50)),
                ('time_slot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='employee.TimeSlot')),
                ('vehicle_plate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='employee.Vehicle')),
            ],
        ),
        migrations.AddField(
            model_name='booking',
        ...
        migrations.AddField(
            model_name='booking',
            name='vehicle_plate',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='employee.Vehicle'),
        ),
    ]
